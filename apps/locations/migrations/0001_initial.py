...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('locations_address', (
            ...
            ('postal_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.PostalCode'], null=True)),
        ...
        db.create_table('locations_postalcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('poly', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, spatial_index=False)),
        ))
        db.send_create_signal('locations', ['PostalCode'])

        # Add all the countries in product_details for a start.
        if not db.dry_run:
            ...
            for u in User.objects.all():
                print u
                orm.Address.objects.create(user=u)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('locations_postalcode')
